  ...
  return (
    <div className="flex md:flex-row flex-col px-5 md:px-10 lg:px-20 pt-5 md:pt-10 bg-[#f8f8f8]">
      <div className="w-full md:w-2/3 md:pr-20 flex flex-col justify-center text-center md:text-start gap-10">
        <div className="w-full pt-[10%] font-semibold italic text-[#0e2920] text-[16px] md:text-[18px] lg:text-[24px]  tracking-[0] leading-[normal]">
          ABOUT US
        </div>
        <p className="w-full font-bold text-[#0e2920] text-[16px] md:text-[24px] lg:text-[48px] tracking-[0] leading-[normal]">
